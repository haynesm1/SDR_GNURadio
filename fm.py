...
class fm(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Blocks
        ##################################################
        self._rx_freq_range = Range(80, 120, 0.1, 100.0, 200)
        self._rx_freq_win = GrRangeWidget(self._rx_freq_range, self.set_rx_freq, "Frequency (MHz)", "counter_slider", float, QtCore.Qt.Horizontal, "value")
        ...
        self.network_udp_source_0 = network.udp_source(gr.sizeof_gr_complex, 1, 1001, 0, 4096, False, False, False)
        ...
        self.connect((self.network_udp_source_0, 0), (self.qtgui_sink_x_0, 0))
